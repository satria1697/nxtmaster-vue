...
<script>
import Api from "../../api";
import Form from "../../components/Hospital/Pasien/FormPasien";
  ...
  methods: {
    ...
    getDataAgama(params) {
      ...
      Api.agama
        .filter(params)
        .then(res => {
          self.dataAgama = res.data.data;
        })
        .catch(err => {
          console.log(err);
        });
    },
    getDataPekerjaan(params) {
      let self = this;
      Api.pekerjaan
        .filter(params)
        .then(res => {
          self.dataPekerjaan = res.data.data;
        })
        .catch(err => {
          console.log(err);
        });
    },
    getDataPendidikan(params) {
      let self = this;
      Api.pendidikan
        .filter(params)
        .then(res => {
          self.dataPendidikan = res.data.data;
        })
        .catch(err => {
          console.log(err);
        });
