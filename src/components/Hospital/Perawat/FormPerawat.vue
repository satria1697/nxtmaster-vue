              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="form form-group col-10">
                    <label for="formDesc" class="top">Nama Perawat</label>
                    <input
                      id="formDesc"
                      class="bottom form-control"
                      v-model="dataAll.namaperawat"
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="form form-group col-10">
                    <label for="formDesc" class="top">Nomer HP Perawat</label>
                    <input
                      id="formDesc"
                      class="bottom form-control"
...
export default {
  ...
  methods: {
    ...
    register(status, id) {
      let rawData = {
        namaperawat: this.dataAll.namaperawat,
      ...
      // console.log(formData.get('namaperawat'));
      // console.log(Api.perawat.register);
      if (status === "submit") {
        Api.perawat
          .register(formData)
          .then(resp => {
