              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="form form-group col-6">
                    <label for="formDesc" class="top">Color</label>
                    <input
                      id="formDesc"
                      class="bottom form-control"
                      v-model="dataAll.warna"
                    />
                  </div>
                  <div class="form form-group col-6">
                    <label for="formDesc" class="top">Value</label>
                    <input
                      id="formDesc"
                      class="bottom form-control"
                      v-model="dataAll.nilai"
                    />
                  </div>
                </div>
              </div>
  ...
  methods: {
    ...
    register(status, id) {
      let rawData = {
        ...
        warna: this.dataAll.warna,
        nilai: this.dataAll.nilai
      };
